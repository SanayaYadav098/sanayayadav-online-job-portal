...
$basePath = count($pathParts) > 1 ? '/' . $pathParts[0] : '';
?>
<div id="header">
  <div class="container">
    ...
    <div class="navigation header-right">
      ...
      if (isset($_SESSION['email'])) {
        ...
        echo '<a href="' . $basePath . '/dashboard/dashboard.php" class="nav-link"> <i class="fa-solid fa-table-cells-large"></i> Dashboard</a>';
        echo '<a href="' . $basePath . '/dashboard/editProfile.php" class="nav-link"> <i class="fa-solid fa-user"></i> My Profile</a>';
        echo '<a href="' . $basePath . '/process/logout.php" class="nav-link"> <i class="fa-solid fa-power-off"></i> Logout</a>';
        echo '</div>';
        echo '</div>';
      } else {
        // User is not logged in, display the "Sign In" button
        echo '<a href="' . $basePath . '/login.php" class="btn">Sign In</a>';
      }
      ?>
    </div>
  </div>
