          ...
          <div class="information-wrapper">
            <div class="apply-save-box">
              ...
              if (isset($_SESSION['role_id']) && $_SESSION['role_id'] == 1) :  ?>
                ...
                ?>
                  <a href="#" class="btn btn-secondary-form">Applied<i class="fa-solid fa-check"></i></a>
                  <?php else :
                  $deadline = date_create($row['deadline']);
                  $now = date_create(date("Y-m-d"));
                  if ($now > $deadline) :
                  ?>
                    <a href="#" class="btn btn-secondary-form">Expired<i class="fa-solid fa-ban"></i></a>
                  <?php else : ?>
                    <a href="./process/applyJob.php?key=<?php echo md5($job_id) . '&id=' . $job_id . '&cid=' . $company_id ?>" class="btn btn-secondary-form">Apply Job<i class="fa-solid fa-arrow-right"></i></a>
                  <?php endif; ?>
                <?php
                endif; ?>
                <?php
                ...
                if ($saved->num_rows > 0) :
                ?>
                  <a href="#" class="btn btn-secondary-form">Saved<i class="fa-solid fa-bookmark"></i></a>
                <?php else : ?>
                  <a href="./process/saveJob.php?key=<?php echo md5($job_id)  . '&id=' . $job_id ?>" class="btn btn-secondary-form">Save Job<i class="fa-solid fa-bookmark"></i></a>
                <?php endif; ?>
              <?php else : ?>
                <a href="./process/applyJob.php?key=<?php echo md5($job_id) . '&id=' . $job_id . '&cid=' . $company_id ?>" class="btn btn-secondary-form">Apply Job<i class="fa-solid fa-arrow-right"></i></a>
              <?php endif; ?>
